    ...
    >
      <article className="mx-auto max-w-3xl">
        ...
        >
          ...
          <section>
            <p className="mb-4">
              These Digital Content & Subscription Terms apply to all purchases,
              subscriptions and digital products offered through the LoveIQ
          ...
          <section>
            ...
            <p>
              All content is created specifically for you based on your inputs
              and is not reusable or returnable.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-white font-semibold mb-4">
              4. Right of Withdrawal & Loss of the Right of Withdrawal for
              Digital Content (Consumers)
            </h2>
            <p className="mb-4">
              Under EU law, consumers normally have a 14-day right of
              withdrawal. However, for LoveIQ digital content:
            </p>
            <p className="mb-4">You expressly agree that:</p>
            <ul className="list-disc list-inside mb-4 space-y-1">
              <li>
                LoveIQ begins performance immediately after purchase, and
              </li>
              <li>
                you thereby lose your statutory right of withdrawal once the
            ...
            <p>
              You acknowledge that by giving this consent you lose your
          ...
          <section>
            ...
            <p className="mb-4">
              Once digital content (including reports, unlocked sections or
              subscription access) has been delivered or activated, refunds are
              excluded.
            </p>
          ...
          <section>
            ...
            <p>
              ...
              period. No partial refunds are granted.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We may change subscription prices. Users will be informed in
              advance. If you do not agree, you may cancel before the new price
              applies.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Payments are processed by external providers (e.g. Stripe). We do
          ...
          <section>
            ...
            <p>
              You may cancel subscriptions at any time. We may terminate
              accounts for violations of law or Terms. Termination does not
              entitle you to a refund for already delivered digital content.
            </p>
          </section>
