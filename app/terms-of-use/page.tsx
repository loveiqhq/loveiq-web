...
export const metadata: Metadata = {
  ...
  description:
    "LoveIQ Terms of Use - Rules and guidelines for using our platform.",
};
      ...
      <article className="mx-auto max-w-3xl">
        ...
        >
          ...
          <section>
            ...
            <p>
              LoveIQ is not a medical, therapeutic, or diagnostic service.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                reverse-engineer or attempt to extract models, scoring systems,
                or algorithms
              </li>
          ...
          <section>
            ...
            <p>
              Doing so may lead to account suspension or termination.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We are not required to provide prior notice where necessary to
              protect users, the platform, or legal compliance.
            </p>
          </section>
