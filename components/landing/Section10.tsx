      ...
      <div className="content-shell relative flex flex-col items-center gap-12 animate-on-scroll">
        ...
        <div className="grid w-full gap-6 md:grid-cols-3 animate-on-scroll">
          ...
          <div className="group relative overflow-hidden rounded-[34px] bg-[#150a22] p-[14px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.35)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_28px_60px_-15px_rgba(254,104,57,0.35)]">
            ...
            <div className="relative flex h-[410px] flex-col rounded-[28px] bg-gradient-to-b from-[#0f0a18] to-[#130c1d] p-5">
              <div className="mb-4 flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#fe6839]/70 transition-colors duration-300 group-hover:bg-[#fe6839]" />
              ...
              <div className="relative flex flex-1 items-center justify-center">
                <div className="relative flex h-36 w-36 items-center justify-center">
                  ...
                  >
                    ...
                    <circle cx="60" cy="60" r="48" stroke="#2a2432" strokeWidth="10" />
                    <circle
                      cx="60"
                      cy="60"
                      r="48"
                  ...
                  <div className="absolute inset-[12px] rounded-full border border-[#26212f] bg-[#0f0a18]" />
                  <div className="absolute inset-0 flex items-center justify-center text-center">
                    <div className="leading-tight">
                      <p className="text-2xl font-semibold text-white">20%</p>
                      <p className="text-[10px] uppercase tracking-[0.2em] text-white/55">Satisfaction</p>
                    </div>
                  </div>
                </div>

                <div className="absolute bottom-4 right-4 flex items-center gap-2 rounded-[12px] border border-white/10 bg-[#1e102e]/90 px-3 py-2 text-xs font-semibold text-white shadow-[0_16px_30px_rgba(0,0,0,0.25)] transition-all duration-500 translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100">
                  <span className="inline-flex h-2 w-2 animate-pulse rounded-full bg-[#fe6839]" />
                  <span>Live Data</span>
                </div>
              </div>
          ...
          {/* Card 2 */}
          <div className="group relative overflow-hidden rounded-[34px] bg-[#150a22] p-[14px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.35)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_28px_60px_-15px_rgba(84,20,117,0.35)]">
            <div className="pointer-events-none absolute inset-[-1px] rounded-[34px] bg-gradient-to-b from-[#541475]/30 to-transparent opacity-0 blur-[4px] transition-opacity duration-500 group-hover:opacity-100" aria-hidden />
            <div className="relative flex h-[410px] flex-col rounded-[28px] bg-gradient-to-b from-[#0f0a18] to-[#130c1d] p-5">
              <div className="mb-4 flex items-center gap-2">
              ...
              <div className="relative flex flex-1 flex-col items-center justify-center gap-6">
                <div className="flex w-full max-w-[240px] items-center justify-between text-[11px] font-semibold uppercase tracking-[0.18em] text-white/60">
                  <span>Women</span>
                  <span>Men</span>
                </div>

                <div className="relative flex w-full max-w-[260px] flex-col gap-6">
                  ...
                  <div className="relative">
                    <span className="absolute -top-16 left-[42%] -translate-x-1/2 rounded-md bg-[#541475] px-2 py-1 text-[10px] font-bold text-white opacity-0 shadow-lg transition-all duration-300 group-hover:-translate-y-1 group-hover:opacity-100">
                      42%
          ...
          {/* Card 3 */}
          <div className="group relative overflow-hidden rounded-[34px] bg-[#150a22] p-[14px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.35)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_28px_60px_-15px_rgba(46,1,71,0.35)]">
            <div className="pointer-events-none absolute inset-[-1px] rounded-[34px] bg-gradient-to-b from-[#2e0147]/50 to-transparent opacity-0 blur-[6px] transition-opacity duration-500 group-hover:opacity-100" aria-hidden />
            <div className="relative flex h-[410px] flex-col rounded-[28px] bg-gradient-to-b from-[#0f0a18] to-[#130c1d] p-5">
              <div className="mb-4 flex items-center gap-2">
              ...
              <div className="relative flex flex-1 flex-col items-center justify-center gap-6">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-gradient-to-br from-[#2e0147] to-[#541475] text-white shadow-[0_18px_40px_rgba(0,0,0,0.35)] transition-transform duration-500 group-hover:rotate-6">
                ...
                <div className="flex w-full max-w-[240px] flex-col items-center gap-2">
                  <div className="inline-flex h-[41px] items-end gap-[6px] rounded-lg border border-white/5 bg-white/5 px-4 py-2">
                    <div className="h-3 w-1.5 rounded-[2px] bg-[#2e0147] transition-all duration-300 group-hover:h-6" />
                    <div className="h-5 w-1.5 rounded-[2px] bg-[#3a1b54] transition-all duration-300 delay-75 group-hover:h-3" />
                    <div className="h-2 w-1.5 rounded-[2px] bg-[#4a226c] transition-all duration-300 delay-100 group-hover:h-5" />
                    <div className="h-6 w-1.5 rounded-[2px] bg-[#5b2a82] transition-all duration-300 delay-150 group-hover:h-8" />
                    <div className="h-10 w-1.5 rounded-[2px] bg-[#f87171] transition-all duration-300 delay-200 group-hover:h-4" />
                  </div>
                  <p className="text-[11px] font-semibold text-[#f97316] opacity-0 transition-opacity duration-300 group-hover:opacity-100">
