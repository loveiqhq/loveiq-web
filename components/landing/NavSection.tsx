    ...
    <header className="pointer-events-none fixed inset-x-0 top-0 z-40 px-4 sm:top-3">
      <div className="content-shell">
        <div className="relative pointer-events-auto">
          ...
          <nav className="relative mx-auto flex w-full max-w-[1200px] items-center justify-between gap-3 rounded-[999px] bg-gradient-to-r from-[#1b0f2a] via-[#120a20] to-[#1b0f2a] px-3 py-2 shadow-[0_25px_80px_rgba(0,0,0,0.55)] backdrop-blur sm:gap-5 sm:pl-6 sm:pr-2 sm:py-[6px]">
