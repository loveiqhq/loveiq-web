                ...
                {term.extendedNotes && (
                  <div className="space-y-6 reveal-on-scroll stagger-3">
                    <div className="flex items-center gap-3">
                      ...
                      >
                        <path d="M3.33398 6.6665C3.33398 4.30984 3.33398 3.13067 4.06648 2.399C4.79815 1.6665 5.97732 1.6665 8.33398 1.6665H11.6673C14.024 1.6665 15.2032 1.6665 15.9348 2.399C16.6673 3.13067 16.6673 4.30984 16.6673 6.6665V13.3332C16.6673 15.6898 16.6673 16.869 15.9348 17.6007C15.2032 18.3332 14.024 18.3332 11.6673 18.3332H8.33398C5.97732 18.3332 4.79815 18.3332 4.06648 17.6007C3.33398 16.869 3.33398 15.6898 3.33398 13.3332V6.6665" stroke="#FE6839" strokeWidth="1.25"/>
                        <path d="M16.5823 13.333H6.58232C5.80732 13.333 5.41982 13.333 5.10148 13.418C4.23871 13.6494 3.56493 14.3235 3.33398 15.1863" stroke="#FE6839" strokeWidth="1.25"/>
                        <path d="M6.66602 5.83301H13.3327M6.66602 8.74967H10.8327M16.2493 15.833H6.66602" stroke="#FE6839" strokeWidth="1.25" strokeLinecap="round"/>
                      </svg>
                        ...
                        >
                          <div className="shrink-0 pt-1">
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <path d="M6.10281 3.6055C6.94747 2.09083 7.36947 1.3335 8.00081 1.3335C8.63214 1.3335 9.05414 2.09083 9.89881 3.6055L10.1175 3.9975C10.3575 4.42816 10.4775 4.6435 10.6641 4.7855C10.8508 4.9275 11.0841 4.98016 11.5508 5.0855L11.9748 5.1815C13.6148 5.55283 14.4341 5.73816 14.6295 6.3655C14.8241 6.99216 14.2655 7.64616 13.1475 8.9535L12.8581 9.2915C12.5408 9.66283 12.3815 9.84883 12.3101 10.0782C12.2388 10.3082 12.2628 10.5562 12.3108 11.0515L12.3548 11.5028C12.5235 13.2475 12.6081 14.1195 12.0975 14.5068C11.5868 14.8942 10.8188 14.5408 9.28414 13.8342L8.88614 13.6515C8.45014 13.4502 8.23214 13.3502 8.00081 13.3502C7.76947 13.3502 7.55147 13.4502 7.11547 13.6515L6.71814 13.8342C5.18281 14.5408 4.41481 14.8942 3.90481 14.5075C3.39347 14.1195 3.47814 13.2475 3.64681 11.5028L3.69081 11.0522C3.73881 10.5562 3.76281 10.3082 3.69081 10.0788C3.62014 9.84883 3.46081 9.66283 3.14347 9.29216L2.85414 8.9535C1.73614 7.64683 1.17747 6.99283 1.37214 6.3655C1.56681 5.73816 2.38747 5.55216 4.02747 5.1815L4.45147 5.0855C4.91747 4.98016 5.15014 4.9275 5.33747 4.7855C5.52481 4.6435 5.64414 4.42816 5.88414 3.9975L6.10281 3.6055" stroke="#FE6839"/>
                            </svg>
                          </div>
                          <p className="text-[#d1d5db] text-base font-light leading-6">
                            {example}
                          </p>
                        </div>
                      ))}
...
{/* Common Misunderstandings Section */}
              ...
              <div className="lg:w-[267px] space-y-8 reveal-on-scroll stagger-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-x-2 gap-y-2">
                      {term.tags.map((tag, i) => (
                        <span
                          key={i}
                          className="text-xs text-[rgba(254,104,57,0.7)]"
                        >
                          #{tag}
                        </span>
                      ))}
                ...
                <div className="rounded-2xl border border-white/10 p-6 space-y-4 bg-gradient-to-br from-[rgba(46,1,71,0.5)] to-[#0a0510]">
                  ...
                  <p className="text-sm font-light leading-[1.625] text-[#9ca3af]">
                    We identify patterns related to {term.term} by analyzing
                    responses in our assessment modules, helping you understand
            ...
            <div className="mt-16 pt-10 border-t border-white/10 text-center space-y-8 reveal-on-scroll">
              <p className="font-serif text-lg italic text-white/40">
                &ldquo;You don&apos;t need to label yourself. These terms help describe
                patterns — not define you.&rdquo;
              </p>
              <Link
                href="/glossary"
