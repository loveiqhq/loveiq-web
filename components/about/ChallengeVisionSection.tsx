...
const GoalIcon: FC = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 13V2L20 6L12 10" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
